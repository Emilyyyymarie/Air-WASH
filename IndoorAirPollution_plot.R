PM2.5concentration_plot <- function(heatvalueinput,emissionfactorgkginput,stovepowerMJhourinput,efficiencyinput,airexchangeinput,volumeinput,drinkingwateronepersoninput,energyinput,backgroundconcentrationinput) #g/kg for emissionfactor
{
...
return(watercookingconcentrationtime)
}
