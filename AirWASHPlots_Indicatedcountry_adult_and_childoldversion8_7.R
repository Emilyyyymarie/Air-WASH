...
print("adult")
#fix these, reading in wrong file . . . .
...
print("child")
watersummarychild<-read.csv(file.path(currentresultspath,paste("waterDALYsdata",country,"child.csv",sep="")),header=TRUE)  #need to update
watersummarysdchild<-read.csv(file.path(currentresultspath,paste("waterDALYsdatasd",country,"child.csv",sep="")),header=TRUE) #need to update
