...
#plot(hourseq,cookingconcentrationtime,main="just cooking",type="l")#

#plot(hourseq,waterheatingconcentrationtime,main="just water heating",type="l")
#plot(hourseq,watercookingconcentrationtime,main="both",type="l")
...
heatingconcentration=mean(heatingconcentrationtime)
heatingcookingconcentration=mean(heatingcookingconcentrationtime)
heatingcookingwaterconcentration=mean(heatingcookingwaterconcentrationtime)
concentrations=c(cookingconcentration,waterheatingconcentration,watercookingconcentration,stovenumber,heatingconcentration,heatingcookingconcentration,heatingcookingwaterconcentration)
return(concentrations)
  #############****PMmatrix=cbind(hourseq,watercookingconcentrationtime)
  ##############****PMArray[i,,]<-PMmatrix
}
